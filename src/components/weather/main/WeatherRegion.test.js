...
describe('WeatherRegionコンポーネント', () => {
    ...
    it('プロップスのテスト', () => {
        const wrapper = shallow(<WeatherRegion todayTomorrowData={todayTomorrowData} pollenData={pollenData} weekData={weekData} todayTomorrowIndexData={todayTomorrowIndexData} />);
